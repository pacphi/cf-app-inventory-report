...
public class DatabaseCreator implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		try {
			createAppDetailTable();
			createSpaceUsersTable();
        } catch (SQLException e) {
            throw new SQLRuntimeException(e);
        }
	}

	protected void createAppDetailTable() throws SQLException {
	...
	protected void createSpaceUsersTable() throws SQLException {
		Connection c = database.connection().blockingGet();
        c.setAutoCommit(true);
